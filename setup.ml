...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c9b01295dd289dabdde89ecfb011332) *)
(*
...
let setup_t =
  {
       ...
       CustomPlugin.Build.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("PREFIX=$prefix", ["omake"]))];
     ...
     package =
       {
          ...
          authors = ["lmdexpr"];
          homepage = None;
          synopsis = "library for numerical calculation";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\017x\205\169\193U\176\246_p\b\154\194\215\231\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
